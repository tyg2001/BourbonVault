        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Proof = table.Column<decimal>(type: "numeric", nullable: false),
                    PurchasePrice = table.Column<decimal>(type: "numeric", nullable: false),
                    PurchaseDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    PurchaseLocation = table.Column<string>(type: "text", nullable: true),
                    CurrentEstimatedValue = table.Column<decimal>(type: "numeric", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bottles_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BottleTags_Bottles_BottleId",
                        column: x => x.BottleId,
                        principalTable: "Bottles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BottleTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppearanceRating = table.Column<int>(type: "integer", nullable: false),
                    NoseRating = table.Column<int>(type: "integer", nullable: false),
                    TasteRating = table.Column<int>(type: "integer", nullable: false),
                    FinishRating = table.Column<int>(type: "integer", nullable: false),
                    OverallRating = table.Column<int>(type: "integer", nullable: false),
                    AppearanceNotes = table.Column<string>(type: "text", nullable: false),
                    NoseNotes = table.Column<string>(type: "text", nullable: false),
                    TasteNotes = table.Column<string>(type: "text", nullable: false),
                    FinishNotes = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TastingNotes_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bottles_ApplicationUserId",
                table: "Bottles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BottleTags_BottleId",
                table: "BottleTags",
                column: "BottleId");

            migrationBuilder.CreateIndex(
                name: "IX_BottleTags_TagId",
                table: "BottleTags",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_TastingNotes_ApplicationUserId",
                table: "TastingNotes",
                column: "ApplicationUserId");
